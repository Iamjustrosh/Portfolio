  ...
  return (
    <>
      <div className="home-page min-h-screen flex flex-col">
        <img src={vector2} loading="lazy" alt="" className="absolute right-0 top-0 z-0 pointer-events-none" />
        <img src={vector2} loading="lazy" alt="" className="absolute right-0 top-0 z-0 pointer-events-none" />
        ...
        <div className="hero-img-container relative flex flex-col items-center w-full h-[260px] md:h-[450px] mb-8">
          ...
          <div className="particles absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-md md:w-1/3">
            <img src={particles} loading="lazy" alt="" className="w-full h-auto" />
          </div>
          {/* Avatar */}
          <div className="avatar absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-30 w-md md:w-1/3">
            <img src={avatar} loading="lazy" alt="" className="w-full h-auto" />
          </div>
          {/*Skills Logos */}
          <div className="skills-icons pointer-events-none absolute inset-0 w-full h-full">
            <img loading="lazy" className="absolute h-auto z-20 right-5  top-12 w  md:right-52 md:top-12 w-12 md:w-34" src={pp} alt="" />
            <img loading="lazy" className="absolute h-auto z-20 left-14  top-6 md:left-1/4 w-12 md:w-44" src={mdb} alt="" />
            <img loading="lazy" className="absolute h-auto z-20 left-3  top-40  md:left-1/3 md:top-40  w-12 md:w-32" src={tailwind} alt="" />
            <img loading="lazy" className="absolute h-auto z-20 left-12  bottom-2 md:left-102 md:bottom-8 w-12 md:w-28" src={github} alt="" />
            <img loading="lazy" className="absolute h-auto z-20 right-12  md:right-1/4 md:top-4 w-12 md:w-40 -translate-x-1/2" src={react} alt="" />
            <img loading="lazy" className="absolute h-auto z-20 left-6  top-1/3  md:left-65 md:top-1/3 w-12 md:w-28" src={css} alt="" />
            <img loading="lazy" className="absolute h-auto z-20 right-3 bottom-22  md:right-1/3 md:bottom-32 w-12 md:w-20" src={html} alt="" />
            <img loading="lazy" className="absolute h-auto z-20 right-8 bottom-4  md:right-1/8 md:bottom-10 w-12 md:w-48 -translate-x-1/2" src={figma} alt="" />
          </div>
        </div>
